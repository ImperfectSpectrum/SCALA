...
object Adts {
  ...
  def main(args: Array[String]): Unit ={
    println("testGetNth: " + testGetNth(List(1,2,3,4,5),0))
    println("testDouble: " + testDouble(Some(2)))
    println("testIsEven(2): " + testIsEven(8))
    println("testIsEven(3): " + testIsEven(5))
    println("testSafeDivide(4,2): " + testSafeDivide(4,2))
    println("testSafeDivide(4,0): " + testSafeDivide(4,0))
    println("testGoodOldJava((str:String)=>str.toInt,\"123\")=>" + testGoodOldJava((str:String)=>str.toInt,"257"))
    println("testGoodOldJava((str:String)=>str.toInt,\"asd\")=>" + testGoodOldJava((str:String)=>str.toInt,"zxc"))
  }
