...
object Sequence {
  ...
  def main(args: Array[String]): Unit ={
    ...
    val seq2 = Seq(1,2,3,3,2,1)
    println("testLastElement=>" + testLastElement(seq1))
    println("testZip=>" + testZip(seq1,seq2))
    println("testForAll=>" + testForAll(seq1)(num => num > 4))
    println("testForAll=>" + testForAll(seq1)(num => num < 111))
    println("testPalindrom=>" + testPalindrom(seq1))
    println("testPalindrom=>" + testPalindrom(seq2))
    println("testFlatMap=>" + testFlatMap(seq1)(num => Seq (num + 1)))
  }
